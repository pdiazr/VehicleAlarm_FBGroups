...
public class SdpUtils
{
    ...
    public static void parseSDP(Agent localAgent, String sdp)
            throws Exception
    {
        String newSdp=filterOrigin(sdp);
        Log.d(Globals.TAG, "NEW SDP: "+newSdp);

        NistSdpFactory factory = new NistSdpFactory();
        SessionDescription sdess = factory.createSessionDescription(newSdp);
    ...
    private static String filterOrigin(String str) {
